...
Before you doing anything please make sure you have the correct version of **NPM** and **NODE** installed. Recommand to use [nvm](https://github.com/nvm-sh/nvm) to install and manage different versions of nodejs (and npm).
